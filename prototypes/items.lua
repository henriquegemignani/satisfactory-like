...
data:extend {
    ...
    make_belt_item("sl-mk5-transport-belt", "a[transport-belt]-d[transport-belt]", "__Krastorio2Assets__/icons/entities/advanced-transport-belt.png"),
    make_belt_item("sl-mk6-transport-belt", "a[transport-belt]-e[transport-belt]", "__Krastorio2Assets__/icons/entities/superior-transport-belt.png"),
    ...
    make_belt_item("sl-mk5-underground-belt", "b[underground-belt]-d[underground-belt]", "__Krastorio2Assets__/icons/entities/advanced-underground-belt.png"),
    make_belt_item("sl-mk6-underground-belt", "b[underground-belt]-e[underground-belt]", "__Krastorio2Assets__/icons/entities/superior-underground-belt.png"),
    make_belt_item("sl-mk1-splitter", "c[splitter]-0[splitter]", "__satisfactory-like__/graphics/icons/splitter/splitter.png"),
    make_belt_item("sl-mk5-splitter", "c[splitter]-d[splitter]", "__Krastorio2Assets__/icons/entities/advanced-splitter.png"),
    make_belt_item("sl-mk6-splitter", "c[splitter]-e[splitter]", "__Krastorio2Assets__/icons/entities/superior-splitter.png"),
}
